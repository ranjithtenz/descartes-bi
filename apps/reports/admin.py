...
from reports.models import FilterExtra, SerieType, GroupPermissionFilterValues, UserPermissionFilterValues, UserPermission, GroupPermission, Report, Serie, Filterset, Filter, Menuitem, SeriesStatistic, ReportStatistic
...
class FilterAdmin(admin.ModelAdmin):
	list_display = ('name', 'description', 'type', 'label', 'default', 'get_parents')
	inlines = [
...
class SerieAdmin(admin.ModelAdmin):
	...
	fieldsets = (
			(None, {
				'fields': ('name', 'label', 'tick_format', 'query', 'description')
			}),
			(_(u'Validation'), {
				'classes': ('collapse-open',),
				'fields': ('validated', 'validated_date', 'validated_person', 'validation_description')
			}),
	)	
...
class ReportAdmin(admin.ModelAdmin):
	...
	list_display = ('title', 'description', 'type', 'get_series', 'get_parents')
...
class SeriesStatisticAdmin(ReadOnlyAdminFields, admin.ModelAdmin):
	...
	list_display = ['id', 'timestamp', 'serie', 'user', 'execution_time', 'params']
...
class ReportStatisticAdmin(ReadOnlyAdminFields, admin.ModelAdmin):
	...
	list_display = ['id', 'timestamp', 'report', 'user', 'execution_time', 'params']
